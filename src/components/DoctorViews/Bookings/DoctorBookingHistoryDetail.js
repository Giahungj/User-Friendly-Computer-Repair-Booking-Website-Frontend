...
import { Rating, CircularProgress, Box } from '@mui/material';
    ...
    if (!data) return (
        <div className="container d-flex justify-content-center align-items-center" style={{ minHeight: "100vh" }}>
            <div className="shadow-lg p-5 text-center bg-light rounded-3" style={{ maxWidth: "600px" }}>
                ...
                <p className="text-muted m-0">Hiện tại bạn không có thông tin của lịch hẹn này.</p>
                <p className="text-muted mb-4">Vui lòng kiểm tra lại hoặc liên hệ đến dịch vụ hỗ trợ nếu cần.</p>
                            ...
                            <div className="card-body">
                                ...
                                <div className="mb-4 border-bottom pb-3" style={{ borderColor: "#dee2e6" }}>
                                    <div className="mb-1">
                                        ...
                                        <p className="m-0">- {data.description || "Không có mô tả"}</p>
                                    </div>
                                    <div className="mb-1">
                                        <strong>Ngày tái khám:</strong>
                                        <p className="m-0">- {data.History.revisitDate || "Không tái khám"}</p>
                                    </div>
